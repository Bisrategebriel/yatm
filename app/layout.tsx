  ...
  "@graph": [
    {
      ...
      description:
        "YAT Business Group is a global trade and logistics company providing import, export, freight, manufacturing, compliance, and consulting services across the globe.",
      foundingDate: "2008",
      numberOfEmployees: { "@type": "QuantitativeValue", value: 10 },
      areaServed: "Worldwide",
      serviceType: ["Import Services", "Export Services", "Freight Logistics", "Trade Compliance", "Manufacturing", "Trade Consulting"],
      contactPoint: [
        { "@type": "ContactPoint", telephone: "(+251) 911-362-741", contactType: "sales", availableLanguage: ["English", "Arabic", "Chinese"] },
        { "@type": "ContactPoint", telephone: "(+251) 911-362-741", contactType: "customer service" },
      ],
      address: {
        "@type": "PostalAddress",
        streetAddress: "Kirkos Sub-city, Woreda 07",
