...
export const metadata: Metadata = {
  ...
  description: "YAT Business Group operates across 40+ countries with offices in New York, Dubai, and Singapore, plus an established agent network spanning all major trade regions.",
  alternates: { canonical: "https://www.yatbusinessgroup.com/network" },
};
...
const offices = [
  {
    ...
    address: "1200 Trade Tower, Financial District, New York, NY 10004",
    phone: "+1 (212) 555-0100",
    email: "newyork@yatbusinessgroup.com",
    services: ["Global trade strategy", "North American import/export", "Trade compliance", "Consulting & advisory"],
    regions: "Americas",
  },
  {
    city: "Dubai",
    country: "UAE",
    type: "MENA & Africa Regional HQ",
